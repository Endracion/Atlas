...
permalink: /contact/
subtitle: "WE ARE WAITING YOU TO GET IN TOUCH WITH US"
---
...
<div class="row">
  <div class="col-md-3">
    <div class="textwidget panel widget">
      <span class="icon-container"><span class="fa fa-home"></span></span> <b>{{ site.company.name }}</b><br>
      {{ site.company.address }}<br><br>
      <span class="icon-container"><span class="fa fa-phone"></span></span> <b>{{ site.company.phone }}</b><br>
      <span class="icon-container"><span class="fa fa-fax"></span></span> <b>1-888-123-4568</b><br>
      <span class="icon-container"><span class="fa fa-envelope"></span></span><a href="mailto:{{ site.company.email }}">{{ site.company.email }}</a>
      <br><br>
      <span class="icon-container"><span class="fa fa-home"></span></span> <b>Mon - Fri 8.00 - 18.00</b><br>
