...
<main class="col-xs-12  col-md-9  col-md-push-3" role="main">
  <div class="row">
    <div class="col-md-4 page-box page-box--block">
      <a class="page-box__picture" href="#design-build">
      ...
      <div class="page-box__content">
        <h5 class="page-box__title  text-uppercase">
          <a href="#design-build">Design and Build</a>
        </h5>
        ...
        <p><a href="#design-build" class="read-more  read-more--page-box">Read more</a></p>
      </div>
    </div>
    <div class="col-md-4 page-box page-box--block">
      <a class="page-box__picture" href="#tiling-painting">
        <img width="360" height="240" src="/assets/images/renotheme/demo/content/content_2.jpg" alt="Tiling and Painting" />
      </a>
      <div class="page-box__content">
        <h5 class="page-box__title text-uppercase">
          <a href="#tiling-painting">Tiling and Painting</a>
        </h5>
        ...
        <p><a href="#tiling-painting" class="read-more read-more--page-box">Read more</a></p>
      </div>
    </div>

    <div class="col-md-4 page-box page-box--block">
      <a class="page-box__picture" href="#construction-management">
      ...
      <div class="page-box__content">
        ...
        <p><a href="#construction-management" class="read-more read-more--page-box">Read more</a></p>
      </div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-4 page-box page-box--block">
      <a class="page-box__picture" href="#hardwood-flooring">
      ...
      <div class="page-box__content">
        ...
        <p><a href="#hardwood-flooring" class="read-more read-more--page-box">Read more</a></p>
      </div>
    </div>
    <div class="col-md-4 page-box page-box--block">
      <a class="page-box__picture" href="#condo-remodeling">
        <img width="360" height="240" src="/assets/images/renotheme/demo/content/content_7.jpg" alt="Condo Remodeling" />
      </a>
      <div class="page-box__content">
        <h5 class="page-box__title text-uppercase">
          <a href="#condo-remodeling">Condo Remodeling</a>
        </h5>
        ...
        <p><a href="#condo-remodeling" class="read-more read-more--page-box">Read more</a></p>
      </div>
    </div>

    <div class="col-md-4 page-box page-box--block">
      <a class="page-box__picture" href="#kitchen-remodeling">
      ...
      <div class="page-box__content">
        ...
        <p><a href="#kitchen-remodeling" class="read-more read-more--page-box">Read more</a></p>
      </div>
    </div>
  </div>
</main>
    ...
    <div class="widget widget_nav_menu  push-down-30">
      <div class="menu-services-menu-container">
        <ul id="menu-services-menu" class="menu">
          <li class="current-menu-item"><a href="#all-services">ALL SERVICES</a></li>
          <li><a href="#construction-management">CONSTRUCTION MANAGEMENT</a></li>
          <li><a href="#design-build">DESIGN AND BUILD</a></li>
          <li><a href="#kitchen-remodeling">KITCHEN REMODELING</a></li>
          <li><a href="#tiling-painting">TILING AND PAINTING</a></li>
          <li><a href="#condo-remodeling">CONDO REMODELING</a></li>
