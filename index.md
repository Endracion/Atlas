---
layout: renotheme-home
title: Les Entrepreneurs Atlas
description: >-
  Les Entrepreneurs Atlas is a licensed general contractor (RBQ 5731-6820-01) delivering
  trusted renovations and outdoor work in Québec. From patio rebuilds to complete home
  renovations, we bring quality craftsmanship to every project.
---
          ...
          <div class="panel-grid-cell">
            <div class="panel widget widget_pt_banner panel-first-child panel-last-child">
              ...
              <div class="banner__buttons">
                ...
                <a class="btn  btn-default" href="/portfolio" target="_self">CHECK OUR PROJECTS</a>
              </div>
  ...
  <div class="row">
    <div class="col-md-4">
      <div class="panel widget widget_pt_featured_page panel-first-child panel-last-child" id="panel-7-1-0-0">
        <div class="has-post-thumbnail page-box page-box--block">
          <a class="page-box__picture" href="/services#design-build">
          ...
          <div class="page-box__content">
            <h5 class="page-box__title  text-uppercase">
              <a href="/services#design-build">Design and Build</a>
            </h5>
            ...
            <p>
              <a href="/services#design-build" class="read-more read-more--page-box">Read more</a>
            </p>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-4">
      <div class="panel widget widget_pt_featured_page panel-first-child panel-last-child" id="panel-7-1-1-0">
        <div class="has-post-thumbnail page-box page-box--block">
          <a class="page-box__picture" href="/services#tiling-painting">
            <img width="360" height="240" src="/assets/images/renotheme/demo/content/content_2.jpg" alt="Tiling and Painting"/>
          </a>
          <div class="page-box__content">
            <h5 class="page-box__title text-uppercase">
              <a href="/services#tiling-painting">Tiling and Painting</a>
            </h5>
            ...
            <p>
              <a href="/services#tiling-painting" class="read-more read-more--page-box">Read more</a>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="panel widget widget_pt_featured_page panel-first-child" id="panel-7-1-2-0">
        <div class="has-post-thumbnail page-box page-box--inline">
          <a class="page-box__picture" href="/services#construction-management">
            <img src="/assets/images/renotheme/demo/content/content_mini_1.jpg" alt="Construction Management"/>
          </a>
          <div class="page-box__content">
            <h5 class="page-box__title text-uppercase">
      ...
      <div class="panel widget widget_pt_featured_page" id="panel-7-1-2-1">
        <div class="has-post-thumbnail page-box page-box--inline">
          <a class="page-box__picture" href="/services#condo-remodeling">
            <img width="100" height="75" src="/assets/images/renotheme/demo/content/content_mini_3.jpg" class="attachment-thumbnail wp-post-image" alt="Condo Remodeling"/>
          </a>
          <div class="page-box__content">
            <h5 class="page-box__title text-uppercase">
      ...
      <div class="panel widget widget_pt_featured_page" id="panel-7-1-2-2">
        <div class="has-post-thumbnail page-box page-box--inline">
          <a class="page-box__picture" href="/services#hardwood-flooring">
            <img width="100" height="75" src="/assets/images/renotheme/demo/content/content_mini_2.jpg" class="attachment-thumbnail wp-post-image" alt="Hardwood Flooring"/>
          </a>
          <div class="page-box__content">
            <h5 class="page-box__title text-uppercase">
      ...
      <div class="panel widget widget_pt_featured_page panel-last-child" id="panel-7-1-2-3">
        <div class="has-post-thumbnail page-box page-box--inline">
          <a class="page-box__picture" href="/services#kitchen-remodeling">
            <img width="100" height="75" src="/assets/images/renotheme/demo/content/content_mini_4.jpg" class="attachment-thumbnail wp-post-image" alt="Kitchen Remodeling"/>
          </a>
          <div class="page-box__content">
            <h5 class="page-box__title text-uppercase">
  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      <div class="panel panel-grid widget widget_black-studio-tinymce panel-last-child" id="panel-7-3-1-1">
        ...
        <div class="textwidget">
          <p>
            <a href="/assets/images/renotheme/demo/content/content_24.jpg" data-rel="prettyPhoto">
              <img class="alignleft wp-image-115 size-medium" src="/assets/images/renotheme/demo/content/content_3.jpg" alt="Content Image" width="300" height="168"/>
            </a>
            <a href="/assets/images/renotheme/demo/content/content_23.jpg" data-rel="prettyPhoto">
              <img class="alignleft wp-image-116 size-medium" src="/assets/images/renotheme/demo/content/content_4.jpg" alt="Content Image" width="300" height="168"/>
            </a>
          </p>
          <p>
            {{ site.company.name }} traces its roots back to 1989 in Colorado and since then have never looked back. With thousands of
    ...
    <div class="panel container">
      ...
      <div class="textwidget">
        <div class="logo-panel">
          <div class="row">
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_01.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_02.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_03.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_04.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_05.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_06.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_07.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_08.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_09.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_10.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_11.jpg" alt="Client" width="208" height="98"></div>
            <div class="col-xs-12 col-sm-2"><img src="/assets/images/renotheme/demo/clients/client_12.jpg" alt="Client" width="208" height="98"></div>
          </div>
        </div>
      </div>
    </div>
